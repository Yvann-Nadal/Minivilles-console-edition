...
namespace MinivillesConsoleEdition
{
    public class Piles
    {
        private Dictionary<string, Card> cardName = new Dictionary<string, Card>()
        {
            ...
            {"Tour", new Card("Tour",ConsoleColor.Green,"Recevez 3 pièces",6,3,[6])},
            ...
            {"Beffroi", new Card("Beffroi",ConsoleColor.Blue,"Recevez 5 pièces",7,5,[8])},
            ...
            {"Laboratoire", new Card("Laboratoire",ConsoleColor.Green,"Recevez 6 pièces",9,6,[10])},
